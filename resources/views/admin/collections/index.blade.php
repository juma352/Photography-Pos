...
@section('breadcrumbs')
    <span class="text-gray-500">Admin</span> / <span class="text-gray-900">Collections</span>
@endsection

@section('content')
<div class="flex justify-between items-center mb-6">
    <div>
        <h2 class="text-2xl font-bold text-gray-900">Photo Collections</h2>
        <p class="text-gray-600">Manage your photography collections</p>
    </div>
...
@if($collections->count() > 0)
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">All Collections ({{ $collections->total() }})</h3>
        </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-16 w-16">
                                        @if($collection->cover_image)
                                            <img class="h-16 w-16 rounded-lg object-cover" 
                                                 src="{{ asset('Images/' . $collection->cover_image) }}" 
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-sm text-gray-500">{{ Str::limit($collection->description, 60) }}</div>
                                        <div class="text-xs text-gray-400 mt-1">Slug: {{ $collection->slug }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-gray-900">{{ $collection->photos_count }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.collections.toggle-status', $collection) }}" class="inline">
                                        @csrf
                                        <button type="submit" 
...
@else
    ...
    <div class="bg-white rounded-lg shadow p-12 text-center">
        ...
        <h3 class="mt-4 text-lg font-medium text-gray-900">No collections found</h3>
        <p class="mt-2 text-gray-500">Get started by creating your first photo collection.</p>
        <div class="mt-6">
            <a href="{{ route('admin.collections.create') }}" 
